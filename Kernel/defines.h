...
#define GDT_LIMIT_4KIB(X)  ((int)((X) / 4096) - 1)
...
CR3_TO_PAGE_DIR(CR3)  devuelve el page directory, donde X es el contenido del registro CR3
...
#define COPY_ATTRIBUTES(X, Y) (CR3_TO_PAGE_DIR((uint32_t)X) | (Y & 0xFFF))
