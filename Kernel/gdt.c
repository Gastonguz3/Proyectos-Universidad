      ...
      [GDT_IDX_CODE_0] =
        {
            ...
            .base_15_0 = GDT_BASE_LOW(0x0000),
            .base_23_16 = GDT_BASE_MID(0x00),
...
// Aca hay una inicializacion estatica de una estructura que tiene su primer componente el tamano 
// y en la segunda, la direccion de memoria de la GDT. 
gdt_descriptor_t GDT_DESC = {(uint16_t)sizeof(gdt) - 1, (uint32_t)&gdt};
