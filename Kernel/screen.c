...
void cleanScreen(){screen_draw_box(0, 0, 50, 80, ' ' ,C_FG_BLACK + C_BG_BROWN );}

void screen_draw_layout(void) {
  cleanScreen();
  screen_draw_box(2,80/2 - 34/2 - 1,5,34 + 2,' ', C_FG_BROWN + C_BG_GREEN);
  print("Iniciando kernel en Modo Protegido", 80/2 - 34/2, 3, C_FG_BROWN + C_BG_GREEN);
  print("Grupo 18", 80/2 - 8/2, 5, C_FG_BROWN + C_BG_GREEN);
}
